...
work and the model work do not collide in one file on every branch.
    ...
    ops.py    sync_run, alert_notification, source_presence
    core.py   the star schema — dimensions first, facts follow
    app_.py   the quarantine queue; enrichment overrides in week 6
...
from lnd.models.core import DimDate, DimEmployee
